...
import { Command, CommandEmpty, CommandGroup, CommandInput, CommandItem } from "@/components/primitives/ui/command";
          ...
          <CommandGroup heading="Examples">
            {presets.map((preset) => (
              ...
              >
                {preset.name}
                <CheckIcon
                  className={cls("ml-auto h-4 w-4", selectedPreset?.id === preset.id ? "opacity-100" : "opacity-0")}
                />
              </CommandItem>
            ))}
          </CommandGroup>
