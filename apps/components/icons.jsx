...
export const Icons = {
  ...
  doubleChevronLeft: (props) => <ChevronsLeft {...props} />,
  doubleChevronRight: (props) => <ChevronsRight {...props} />,
  sun: (props) => <Sun {...props} />,
  ...
  bookMarked: (props) => <BookMarked {...props} />,
  badgeDollarSign: (props) => <BadgeDollarSign {...props} />,
  ...
  chat: (props) => <MessageSquareText {...props} />,
  gift: (props) => <Gift {...props} />,
  thumbsUp: (props) => <ThumbsUp {...props} />,
  thumbsDown: (props) => <ThumbsDown {...props} />,
  ellipsis: (props) => <Ellipsis {...props} />,
  tabletSmartphone: (props) => <TabletSmartphone {...props} />,
  arrowDownNarrowWide: (props) => <ArrowDownNarrowWide {...props} />,
  arrowUpWideNarrow: (props) => <ArrowUpWideNarrow {...props} />,
  sendHorizontal: (props) => <SendHorizontal {...props} />,
  cornerDownRight: (props) => <CornerDownRight {...props} />,
  badgeCheck: (props) => <BadgeCheck {...props} />,
  dashboard: (props) => <LayoutDashboard {...props} />,
  user: (props) => <User {...props} />,
  languages: (props) => <LanguagesIcon {...props} />,
  handHelping: (props) => <HandHelpingIcon {...props} />,
  earth: (props) => <EarthIcon {...props} />,
  filePlus: (props) => <FilePlus2Icon {...props} />,
  libraryBig: (props) => <LibraryBigIcon {...props} />,
  link: (props) => <Link {...props} />,
  camera: (props) => <Camera {...props} />,
  settings: (props) => <Settings {...props} />,
  pen: (props) => <PencilRuler {...props} />,
  // Others
  nextjs: (props) => (
